...
Public Class Lap_Jual_bulan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_penjualan_bangsul_project.Lap_Jual_bulan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLap_Jual_bulan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Lap_Jual_bulan = New Lap_Jual_bulan()
        rpt.Site = Me.Site
        Return rpt
    End Function
